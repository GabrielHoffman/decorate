...
<!---
# Run test of differential correlation using median correlation test
```{r compare.medianCorr, echo=TRUE, message=FALSE, results="hide"}
# sledResMedCorr = evalDiffCorr( simData, metadata$Disease, simLocation, 
#   treeListClusters_collapse, method="medianCorr")

# # get summary of results
# dfMedCorr = summary( sledResMedCorr )

# # print results
# head(dfMedCorr)
```
```{r print.table.medianCorr}
# head(dfMedCorr)    
```
--->
